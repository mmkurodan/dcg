...
public final class MidiDevice {
    ...
    public com.micklab.dcg.wrapper.android.media.midi.MidiDevice.MidiConnection connectPorts(com.micklab.dcg.wrapper.android.media.midi.MidiInputPort arg0, int arg1) {
        return com.micklab.dcg.wrapper.android.media.midi.MidiDevice.MidiConnection.wrap(((android.media.midi.MidiDevice) real).connectPorts(arg0 == null ? null : arg0.getReal(), arg1));
    }
    ...
    public static final class MidiConnection {
        private static final class __DcgwBridgeToken {
        }

        private final java.lang.Object real;

        private MidiConnection(java.lang.Object real, __DcgwBridgeToken token) {
            this.real = real;
        }

        public static com.micklab.dcg.wrapper.android.media.midi.MidiDevice.MidiConnection wrap(android.media.midi.MidiDevice.MidiConnection real) {
            return real == null ? null : new com.micklab.dcg.wrapper.android.media.midi.MidiDevice.MidiConnection(real, (__DcgwBridgeToken) null);
        }

        public android.media.midi.MidiDevice.MidiConnection getReal() {
            return (android.media.midi.MidiDevice.MidiConnection) real;
        }

        public android.media.midi.MidiDevice.MidiConnection unwrap() {
            return getReal();
        }

        public void close() throws java.io.IOException {
            ((android.media.midi.MidiDevice.MidiConnection) real).close();
        }
