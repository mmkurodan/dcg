...
public final class PromptContentItemBulletedText {
    private final android.hardware.biometrics.PromptContentItemBulletedText real;

    public PromptContentItemBulletedText(android.hardware.biometrics.PromptContentItemBulletedText real) {
        this.real = real;
    }
    ...
    public static com.micklab.dcg.wrapper.android.hardware.biometrics.PromptContentItemBulletedText wrap(android.hardware.biometrics.PromptContentItemBulletedText real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.hardware.biometrics.PromptContentItemBulletedText(real);
    }
    ...
    public PromptContentItemBulletedText(java.lang.String arg0) {
        this(new android.hardware.biometrics.PromptContentItemBulletedText(arg0));
    }
