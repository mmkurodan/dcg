...
public final class StringPrepParseException {
    private final android.icu.text.StringPrepParseException real;

    public StringPrepParseException(android.icu.text.StringPrepParseException real) {
        this.real = real;
    }
    ...
    public static com.micklab.dcg.wrapper.android.icu.text.StringPrepParseException wrap(android.icu.text.StringPrepParseException real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.icu.text.StringPrepParseException(real);
    }
    ...
    public StringPrepParseException(java.lang.String arg0, int arg1) {
        this(new android.icu.text.StringPrepParseException(arg0, arg1));
    }

    public StringPrepParseException(java.lang.String arg0, int arg1, java.lang.String arg2, int arg3) {
        this(new android.icu.text.StringPrepParseException(arg0, arg1, arg2, arg3));
    }

    public StringPrepParseException(java.lang.String arg0, int arg1, java.lang.String arg2, int arg3, int arg4) {
        this(new android.icu.text.StringPrepParseException(arg0, arg1, arg2, arg3, arg4));
    }
