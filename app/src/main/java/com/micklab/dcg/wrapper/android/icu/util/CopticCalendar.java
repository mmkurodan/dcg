...
public final class CopticCalendar {
    ...
    public java.lang.String getTemporalMonthCode() {
        return ((android.icu.util.CopticCalendar) real).getTemporalMonthCode();
    }
    ...
    public void setTemporalMonthCode(java.lang.String arg0) {
        ((android.icu.util.CopticCalendar) real).setTemporalMonthCode(arg0);
    }

    public static final int AMSHIR = android.icu.util.CopticCalendar.AMSHIR;
    public static final int BABA = android.icu.util.CopticCalendar.BABA;
    public static final int BARAMHAT = android.icu.util.CopticCalendar.BARAMHAT;
    public static final int BARAMOUDA = android.icu.util.CopticCalendar.BARAMOUDA;
    public static final int BASHANS = android.icu.util.CopticCalendar.BASHANS;
    public static final int EPEP = android.icu.util.CopticCalendar.EPEP;
    public static final int HATOR = android.icu.util.CopticCalendar.HATOR;
    public static final int KIAHK = android.icu.util.CopticCalendar.KIAHK;
    public static final int MESRA = android.icu.util.CopticCalendar.MESRA;
    public static final int NASIE = android.icu.util.CopticCalendar.NASIE;
    public static final int PAONA = android.icu.util.CopticCalendar.PAONA;
    public static final int TOBA = android.icu.util.CopticCalendar.TOBA;
    public static final int TOUT = android.icu.util.CopticCalendar.TOUT;
