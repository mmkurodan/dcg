...
public final class SensorEventListener {
    private final android.hardware.SensorEventListener real;

    public SensorEventListener(android.hardware.SensorEventListener real) {
        this.real = real;
    }
    ...
    public static com.micklab.dcg.wrapper.android.hardware.SensorEventListener wrap(android.hardware.SensorEventListener real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.hardware.SensorEventListener(real);
    }
