...
public final class StructTimespec {
    private final android.system.StructTimespec real;

    public StructTimespec(android.system.StructTimespec real) {
        this.real = real;
    }

    public static com.micklab.dcg.wrapper.android.system.StructTimespec wrap(android.system.StructTimespec real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.system.StructTimespec(real);
    }
