...
public final class BodyTemperatureRecord {
    private final android.health.connect.datatypes.BodyTemperatureRecord real;

    public BodyTemperatureRecord(android.health.connect.datatypes.BodyTemperatureRecord real) {
        this.real = real;
    }
    ...
    public static com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord wrap(android.health.connect.datatypes.BodyTemperatureRecord real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord(real);
    }
    ...
    public static final class Builder {
        private final android.health.connect.datatypes.BodyTemperatureRecord.Builder real;

        public Builder(android.health.connect.datatypes.BodyTemperatureRecord.Builder real) {
            this.real = real;
        }
        ...
        public static com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.Builder wrap(android.health.connect.datatypes.BodyTemperatureRecord.Builder real) {
            return real == null ? null : new com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.Builder(real);
        }
        ...
        public Builder(com.micklab.dcg.wrapper.android.health.connect.datatypes.Metadata arg0, java.time.Instant arg1, int arg2, com.micklab.dcg.wrapper.android.health.connect.datatypes.units.Temperature arg3) {
            this(new android.health.connect.datatypes.BodyTemperatureRecord.Builder(arg0 == null ? null : arg0.unwrap(), arg1, arg2, arg3 == null ? null : arg3.unwrap()));
        }

        public com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord build() {
            return com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.wrap(real.build());
        }

        public com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.Builder clearZoneOffset() {
            return com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.Builder.wrap(real.clearZoneOffset());
        }
        ...
        public com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.Builder setZoneOffset(java.time.ZoneOffset arg0) {
            return com.micklab.dcg.wrapper.android.health.connect.datatypes.BodyTemperatureRecord.Builder.wrap(real.setZoneOffset(arg0));
        }
