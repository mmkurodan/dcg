...
public final class DateFormat {
    private final android.text.format.DateFormat real;

    public DateFormat(android.text.format.DateFormat real) {
        this.real = real;
    }

    public static com.micklab.dcg.wrapper.android.text.format.DateFormat wrap(android.text.format.DateFormat real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.text.format.DateFormat(real);
    }
    ...
    public DateFormat() {
        this(new android.text.format.DateFormat());
    }
