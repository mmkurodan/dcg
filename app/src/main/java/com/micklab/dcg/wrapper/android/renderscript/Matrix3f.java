...
public final class Matrix3f {
    private final android.renderscript.Matrix3f real;

    public Matrix3f(android.renderscript.Matrix3f real) {
        this.real = real;
    }

    public static com.micklab.dcg.wrapper.android.renderscript.Matrix3f wrap(android.renderscript.Matrix3f real) {
        return real == null ? null : new com.micklab.dcg.wrapper.android.renderscript.Matrix3f(real);
    }
    ...
    public Matrix3f() {
        this(new android.renderscript.Matrix3f());
    }

    public Matrix3f(float[] arg0) {
        this(new android.renderscript.Matrix3f(arg0));
    }
